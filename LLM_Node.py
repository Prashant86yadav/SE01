...
async def safe_llm_call(messages: list):
    try:
        deployment = os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME", "gpt-35-turbo")
...
@tool
async def analyze_with_azure_openai(input1: List[Dict[str, str]],user_query: str) -> Dict[str, str]:
    """
